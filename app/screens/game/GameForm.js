...
const buildQuery = (values) => {
  ...
  return {
    method: "GET",
    url: "https://api.themoviedb.org/3/discover/movie?api_key=YOUR_API_KEY",
    params,
  };
};
      ...
      <View style={styles.fixedNavContainer}>
        ...
        {step < 3 ? (
          ...
          <Pressable
            ...
            onPress={() => {
              // Call Formik's submitForm function.
              // In this example, we assume we store the submitForm in a ref (submitFormRef).
              // For simplicity, you can also wrap the fixed nav in Formik.
            }}
          >
...
const styles = StyleSheet.create({
  ...
  fixedNavContainer: {
    position: "absolute",
    bottom: 20, // Adjust to lift the nav higher off the bottom
    left: 0,
    right: 0,
    backgroundColor: "#f0f0f0",
    paddingVertical: 15,
